...
import { register, login, dashbord, deposit, withdraw, sendmoney, contact, exchange, profile, update, passwordchange, Activity, forgot, verifyOtp, isLoginUser, logout, newUserVeify } from '../controllers/user-Controller.js';
import { isAuthenticatedUser } from '../middlewares/auth.js';
import { verifyNewUser } from '../utils/sendOtp.js';
